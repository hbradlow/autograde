...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field instructors on 'Project'
        db.create_table('autograde_project_instructors', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('project', models.ForeignKey(orm['autograde.project'], null=False)),
            ('user', models.ForeignKey(orm['auth.user'], null=False))
        ))
        db.create_unique('autograde_project_instructors', ['project_id', 'user_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field instructors on 'Project'
        db.delete_table('autograde_project_instructors')
