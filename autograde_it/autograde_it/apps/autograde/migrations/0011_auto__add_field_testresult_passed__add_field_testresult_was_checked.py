...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TestResult.passed'
        db.add_column('autograde_testresult', 'passed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'TestResult.was_checked'
        db.add_column('autograde_testresult', 'was_checked',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TestResult.passed'
        db.delete_column('autograde_testresult', 'passed')

        # Deleting field 'TestResult.was_checked'
        db.delete_column('autograde_testresult', 'was_checked')
