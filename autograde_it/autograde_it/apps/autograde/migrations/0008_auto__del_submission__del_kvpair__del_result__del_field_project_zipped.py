...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Project.zipped'
        db.delete_column('autograde_project', 'zipped')
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Project.zipped'
        raise RuntimeError("Cannot reverse this migration. 'Project.zipped' and its values cannot be restored.")
