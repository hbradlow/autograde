...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('autograde_testresult', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('test_case', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['autograde.TestCase'])),
            ('results', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal('autograde', ['TestResult'])


    def backwards(self, orm):
        # Deleting model 'TestResult'
        db.delete_table('autograde_testresult')
