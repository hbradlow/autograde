...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TestCase.expected_results'
        db.add_column('autograde_testcase', 'expected_results',
                      self.gf('django.db.models.fields.TextField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TestCase.expected_results'
        db.delete_column('autograde_testcase', 'expected_results')
