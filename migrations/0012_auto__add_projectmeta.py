...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ProjectMeta'
        db.create_table('autograde_projectmeta', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('project', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['autograde.Project'], unique=True)),
        ...
        db.send_create_signal('autograde', ['ProjectMeta'])


    def backwards(self, orm):
        # Deleting model 'ProjectMeta'
        db.delete_table('autograde_projectmeta')
