...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'TestCase.my_file'
        raise RuntimeError("Cannot reverse this migration. 'TestCase.my_file' and its values cannot be restored.")
