...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'TestResult.test_case'
        raise RuntimeError("Cannot reverse this migration. 'TestResult.test_case' and its values cannot be restored.")
    ...
    models = {
        ...
        'autograde.testresult': {
            ...
            'test_case': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['autograde.TestCase']", 'null': 'True'})
        },
